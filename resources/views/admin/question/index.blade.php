...
<div class="btn-toolbar">
    <div class="btn-group">
        @if (($meta->category === 'private' && hasRight($auth->admin->rights, config('rights.RIGHT_QUESTION'))) || ($meta->category === 'public' && hasRight($auth->admin->rights, config('rights.RIGHT_PUBLIC'))))
